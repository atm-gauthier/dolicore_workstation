...
/**
 * \file    test/phpunit/WorkstationFunctionalTest.php
 * \ingroup workstation
...
/**
 * Class WorkstationFunctionalTest
 *
 ...
 *
 * @package Testworkstation
 */
class WorkstationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modWorkstation')->click();
		} else {
			// Disable the module
			$this->byHref('modWorkstation')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/workstation/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('workstation/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/workstation/admin/about.php');
		$this->authenticate();
		return $this->assertContains('workstation/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('workstationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWorkstation_WorkstationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWorkstation_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
