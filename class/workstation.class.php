...
class Workstation extends CommonObject
{
	 ...
	 */
	public $picto = 'workstation@workstation';
	...
	public $fields=array(
		...
		'status' => array('type'=>'smallint', 'label'=>'Status', 'enabled'=>'1', 'position'=>31, 'default'=>1, 'notnull'=>1, 'visible'=>1, 'index'=>1, 'arrayofkeyval'=>array('0'=>'Disabled', '1'=>'Enabled'),),
		'type' => array('type'=>'select', 'label'=>'Type', 'enabled'=>'1', 'position'=>32, 'default'=>1, 'notnull'=>1, 'visible'=>1, 'arrayofkeyval'=>array('HUMAN'=>'Human', 'MACHINE'=>'Machine', 'HUMANMACHINE'=>'HumanMachine'),),
		...
		'thm_operator_estimated' => array('type'=>'double', 'label'=>'THMOperatorEstimated', 'enabled'=>'1', 'position'=>50, 'notnull'=>0, 'visible'=>1,),
		'thm_machine_estimated' => array('type'=>'double', 'label'=>'THMMachineEstimated', 'enabled'=>'1', 'position'=>50, 'notnull'=>0, 'visible'=>1,),
	);
	public $rowid;
	public $ref;
	public $label;
...
/**
 * Class WorkstationLine. You can also remove this and generate a CRUD class for lines objects.
 */
class WorkstationLine extends CommonObjectLine
{
	// To complete with content of an object WorkstationLine
	// We should have a field rowid, fk_workstation and position
