...
/**
 *  \file       workstation/core/modules/workstation/doc/pdf_standard.modules.php
 *  \ingroup    workstation
...
class pdf_standard_myobject extends ModelePDFMyObject
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->workstation->dir_output.'/myobject')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->workstation->dir_output.'/myobject';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->workstation->dir_output.'/myobject/'.$objectref;
